...
$students = @(
    Get-ADUser `
        ...
        -SearchScope Subtree `
        -Filter * `
        -Properties DisplayName,mail,UserPrincipalName,Enabled,DistinguishedName `
        -ErrorAction Stop
)
...
$students |
    Select-Object Name,DisplayName,SamAccountName,UserPrincipalName,mail,Enabled,DistinguishedName,ObjectGUID,SID |
